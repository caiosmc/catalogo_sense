...
function App() {
  ...
  const agrupadosPorCategoria = [...new Set(produtosFiltrados.map(p => p.categoria))].filter(Boolean);
    ...
    <div style={{ fontFamily: "Arial, sans-serif", color: "#333" }}>
      <div style={{ display: "flex", alignItems: "center", padding: 20 }}>
        <img
          src="/logo-rg.png"
          alt="Logo"
          style={{ width: isMobile ? 70 : 110, marginRight: 15 }}
        />
        <h1 style={{ fontSize: isMobile ? 28 : 44 }}>
      ...
      {modalProduto && (
        <div style={modalOverlayStyle}>
          <div style={modalContentStyle}>
            <button onClick={fecharModal} style={modalCloseStyle}>
              ✖
            </button>
            <div style={{ display: "flex", flexDirection: isMobile ? "column" : "row" }}>
              <div style={{ flex: 1, padding: 10 }}>
                <img
                  src={modalProduto[`imagem_d${imagemAtiva + 1}`] || obterImagemPrincipal(modalProduto)}
